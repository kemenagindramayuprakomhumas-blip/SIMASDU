...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Survei Kepuasan Penyelenggara Zakat & Wakaf</title>
  <style>
    * {
...
<div class="survey-container">
  <h2>Survei Kepuasan Layanan Penyelenggara Zakat & Wakaf</h2>
...
<div class="form-group">
  ...
  <div style="background-color: #f0f8ff; border-left: 5px solid #3498db; padding: 20px; border-radius: 10px; margin-bottom: 35px;">
    ...
    <!-- Pertanyaan Survei -->
    <div class="question">
      <p>1. Apakah anda puas dengan kemudahan informasi prosedur tanah wakaf?</p>
    ...
    <div class="question">
      <p>2. Apakah Anda puas dengan transparansi dan kejelasan informasi mengenai zakat yang disediakan oleh Kementerian Agama?</p>
    ...
    <div class="question">
      <p>3. Apakah Anda puas dengan distribusi zakat yang dikelola oleh Kementerian Agama, baik dalam hal ketepatan sasaran maupun penggunaan dana zakat??</p>
    ...
    <div class="question">
      <p>4.  Apakah Anda puas dengan upaya Kemenag dalam meningkatkan kesadaran masyarakat mengenai zakat dan wakaf?</p>
    ...
    <div class="question">
      <p>5. Apakah anda puas dengan layanan konsultasi terkait pengelolaan zakat yang disediakan oleh kemenag?</p>
    ...
    <input type="hidden" name="seksi" value="pzw">
