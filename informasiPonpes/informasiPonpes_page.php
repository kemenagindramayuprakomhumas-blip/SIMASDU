...
<section id="data-madrasah" class="madrasah-section">
  <div class="container">
    ...
    <div class="madrasah-grid">
      ...
      <!-- RA -->
      <a class="madrasah-card" href="https://docs.google.com/spreadsheets/d/1MSRAuqyqFw_NdGYLVkYIPadx9hcKAHo3/edit?usp=sharing&ouid=113837042151804396775&rtpof=true&sd=true" target="_blank" rel="noopener">
        <div class="madrasah-card-body">
          <div class="madrasah-number">180</div>
        </div>
        <div class="madrasah-label">Pondok Pesantren</div>
      </a>

      <!-- MI -->
      <a class="madrasah-card" href="https://docs.google.com/spreadsheets/d/1T54RB0UKQTeQctivN6Vh5F0DoS7Ic1bB/edit?usp=sharing&ouid=113837042151804396775&rtpof=true&sd=true" target="_blank" rel="noopener">
        <div class="madrasah-card-body">
          <div class="madrasah-number">1056</div>
        </div>
        <div class="madrasah-label">MDT</div>
      </a>

      <!-- MTs -->
      <a class="madrasah-card" href="https://docs.google.com/spreadsheets/d/1KyTGG0a4OBulXJt4EXHKtK0fCMrs7UfS/edit?usp=sharing&ouid=113837042151804396775&rtpof=true&sd=true" target="_blank" rel="noopener">
        <div class="madrasah-card-body">
          <div class="madrasah-number">531</div>
        </div>
        <div class="madrasah-label">LPQ</div>
      </a>
    </div>
  </div>
</section>
